...
class ConstrainedGraspSamplingData(BaseDataset):
    def __init__(self, opt, caching=True):
        ...
        self.root_orien_label = opt.orien_label_root_folder
        ...
        if self.opt.orientation_constrained is True and self.opt.orien_label_root_folder == "" and opt.continuous is False:
            raise SystemExit("please provide the label file if orientation_constrained is set True. Otherwise, use set continuous flag to be True")
    ...
    # def load_data_from_file_orien_label(self, file_path, file_orien_label_path):
    #         return self.load_from_pickle_file_orien_label(file_path, file_orien_label_path)
